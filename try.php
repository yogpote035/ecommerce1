...
if ($_POST) {
  ...
  if($password==$cpassword)
  {
    ...
    echo "passwords should be matched";
       ...
       $sql = "INSERT into rregister(rname, radd, rpass,rconpass) VALUES('" .$rname.  "', '" . $radd . "', '" . $password. "' ,'".$cpassword ."')";
...
<body>
  <div id="container">
    ...
    <div id="menu">
      ...
      <li><a href="Radd.html">Add Product</a></li>
      <li><a href="Rview.html">View product</a></li>
